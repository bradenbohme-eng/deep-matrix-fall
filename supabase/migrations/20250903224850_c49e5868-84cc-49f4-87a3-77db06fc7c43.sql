-- Core warfare simulation schema (fixed)
-- Factions table
...
CREATE TABLE IF NOT EXISTS public.world_war_clock (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  minutes_to_midnight NUMERIC NOT NULL DEFAULT 300,
...
INSERT INTO public.world_war_clock (minutes_to_midnight, tension_factors) VALUES
